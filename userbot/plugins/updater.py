...
OFFICIAL_UPSTREAM_REPO = "https://github.com/SPIDERBHAI/HunterGang"
BOT_IS_UP_TO_DATE = "HunterGang UserBot is up-to-date!."
NEW_BOT_UP_DATE_FOUND = (
    "**HunterGang Update Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Pulling Updates !!"
)
NEW_UP_DATE_FOUND = (
...
async def deploy_start(bot, message, refspec, remote):
    ...
    await message.edit("**The Latest Branch** `Master` **Has Been Pushed To Heroku** \n**Now Trying A Restart To Complete Updation Process ⚠️ !!** To Check If I am Alive Just Do `.alive` or `.help` !!!! Thank For Using HunterGang UserBot Service (◍•ᴗ•◍)❤")
